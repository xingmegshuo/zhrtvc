...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default='sync', help="Name of the run and of the logging directory.")
    ...
    parser.add_argument("--eval_interval", type=int, default=5000,  # Was 10000
    ...
    # for _ in tqdm(range(3 * 60 * 60), 'wait'):
    #     time.sleep(1)
